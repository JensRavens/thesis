...
For an evaluation, the simulated data is exported to Matlab, including the three dimensional electric field (as complex values) and the three axes \question{Lumerical verwendet hier ein Rohdatenformat, die Skalierung, wo welche Achse liegt, wird separat gespeichert (und muss auch extra exportiert werden). muss ich das detaillierter beschreiben?}.
